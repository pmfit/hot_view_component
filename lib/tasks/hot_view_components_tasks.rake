  ...
  namespace :manifest do
    ...
    task :update do
      ...
      File.open(Rails.root.join("app/javascript/controllers/components.js"), "w+") do |index|
        ...
        index.puts
        index.puts %(import { application } from "controllers/application") if HotViewComponents::Manifest.mode === :importmap
        index.puts %(import { application } from "./application") if HotViewComponents::Manifest.mode === :node
        index.puts manifest
      end
    end
  end
